...
echo ""
echo "Files created:"
echo "  .claude/skills/         — 21 workflow skills (incl. /team, /improve, /setup, /plan, /build, /iterative-review)"
echo "  .claude/agents/         — 36 AI agents (12 reviewers + 12 review specialists + 4 planning specialists + 4 build specialists + 4 meta agents)"
...
echo ""
echo "Next steps:"
echo "  1. Run /setup in Claude Code to refine configuration based on detected project state"
