...
echo ""
echo "Files created:"
echo "  .claude/skills/         — 24 workflow skills (incl. /team, /improve, /setup, /plan, /build, /iterative-review, /impact, /index, /search)"
echo "  .claude/agents/         — 40 AI agents (22 analysis + 6 implementation + 4 planning + 8 meta)"
