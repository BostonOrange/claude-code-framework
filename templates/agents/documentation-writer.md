...
- When documenting code that wraps external libraries/frameworks, fetch current docs via Context7 (`resolve-library-id` → `get-library-docs`) to ensure documented behavior matches the actual API — not stale assumptions
