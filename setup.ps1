...
Write-Host "  .claude/skills/         - 18 workflow skills (incl. /team, /improve, /iterative-review, /scaffold-design-system)"
Write-Host "  .claude/agents/         - 17 AI agents (full team + 4 code-quality specialists + review-coordinator)"
Write-Host "  .claude/commands/       - 6 quick commands (quick-test, lint-fix, check-types, branch-status, changelog, dep-check)"
Write-Host "  .claude/rules/          - 13 coding guardrails (api-routes, tests, database, config, error-handling, auth-security, data-protection, design-system, components, code-smells, dry, purity, complexity)"
