...
Write-Host "  .claude/skills/         - 21 workflow skills (incl. /team, /improve, /setup, /plan, /build, /iterative-review)"
Write-Host "  .claude/agents/         - 36 AI agents (12 reviewers + 12 review specialists + 4 planning specialists + 4 build specialists + 4 meta agents)"
