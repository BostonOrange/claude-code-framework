...
Write-Host "  .claude/agents/         - 30 AI agents (12 reviewers + 7 review specialists + 4 planning specialists + 4 build specialists + 3 coordinators)"
Write-Host "  .claude/commands/       - 6 quick commands (quick-test, lint-fix, check-types, branch-status, changelog, dep-check)"
Write-Host "  .claude/rules/          - 16 coding guardrails (api-routes, tests, database, config, error-handling, auth-security, data-protection, design-system, components, code-smells, dry, purity, complexity, frontend-architecture, architecture-layering, api-layering)"
